...
class KskMT940Parser(MT940, parser):
    name = _('KSK MT940 (structured)')
    country_code = 'DE'
    ...
    def handle_tag_25(self, cr, data):
        '''KSK: For current accounts: IBAN+ ISO 4217 currency code'''
        self.current_statement.local_account = data[:-3]

    def handle_tag_60F(self, cr, data):
        super(KskMT940Parser, self).handle_tag_60F(cr, data)
    ...
    def handle_tag_61(self, cr, data):
        super(KskMT940Parser, self).handle_tag_61(cr, data)
    ...
    def handle_tag_86(self, cr, data):
        if not self.current_transaction:
            return
        super(KskMT940Parser, self).handle_tag_86(cr, data)
